...
;; Lancement du mineur
EthDcrMiner64.exe -epool %POOL_ETH% -ewal %ETH%.%RIGNAME%/%MAIL% -epsw x -dcoin pasc -dpool -ethi %MINING_POWER% %POOL_PASC% -dwal 86646.%PASC%.%RIGNAME%/%MAIL% -dpsw x -ftime 10  -tt -%FAN_SPEED%